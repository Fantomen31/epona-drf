"""
Django settings for epona_drf_api project.
...
REST_AUTH = {
    "USER_DETAILS_SERIALIZER": "epona_drf_api.serializers.CurrentUserSerializer",
    "TOKEN_SERIALIZER": "epona_drf_api.serializers.CustomTokenSerializer",
    "USE_JWT": True,
...
WSGI_APPLICATION = 'epona_drf_api.wsgi.application'
